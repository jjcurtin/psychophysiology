...
%2016-09-01:  Removed msgbox command from DataSave and DataCopy, caused error at Ask function. JTK
...
try
    ...
    ListenChar(1); %Not clear if this function is necessary
    ...
    DataSave(ShockRatings, FileName, LocalPath); % Write dat file to local computer with SubID (1), ShockValues(2), ShockRatings (3)
